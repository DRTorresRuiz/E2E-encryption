...
def on_message( client, userdata, msg ):
  ...
  # TODO: Messages coming from two topics can be received. One topic is generated to negotiate the key. The other is for rotating the key, with KMS. 
...
def connect( server, port, typeDevice ):
  ...
  while True:
    client.publish( REGISTRATION_TOPIC, "Hello World!", 2 )
    time.sleep(20)
